...
namespace EventSystem.Core.Migrations
{
    ...
    [Migration("20260625002443_ChangePresaveNotifiedToTimestamp")]
    partial class ChangePresaveNotifiedToTimestamp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventSystem.Core.Entities.Event", b =>
                {
                    ...
                    b.Property<DateTime?>("PresaveOpensAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("EventSystem.Core.Entities.EventPresave", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("EventPresaves");
                });

            modelBuilder.Entity("EventSystem.Core.Entities.EventView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
